  ...
  return (
    <div className={headerStyles.container}>
      <header className={headerStyles.header}>
        <h1 className={headerStyles.headername}>
          {"> " + display_name}
          <span
            className={
              visible ? headerStyles.cursor : headerStyles.cursorhidden
            }
          >
            |
          </span>
        ...
        <ul className={headerStyles.headerlinks}>
          ...
          <li className={headerStyles.divider}> | </li>

          <li className={headerStyles.headerlink}>
            <a
              href="https://github.com/sali9213"
              target="_blank"
              rel="noopener noreferrer"
            >
              Github
          ...
          <li className={headerStyles.headerlink}>
            ...
            <a
              href="https://www.linkedin.com/in/syed-ali-33831b175/"
              target="_blank"
              rel="noopener noreferrer"
            >
              LinkedIn
